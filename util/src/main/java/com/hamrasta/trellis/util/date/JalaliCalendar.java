package com.hamrasta.trellis.util.date;
...
public class JalaliCalendar extends Calendar {
    ...
    public static PersianDate gregorianToPersianDate(Date date){
        return gregorianToPersianDate(date, Locale.getDefault());
    }

    public static PersianDate gregorianToPersianDate(Date date, Locale aLocale) {
        PersianDate persianDate = new PersianDate(date, aLocale);
        YearMonthDate gregorianToJalaliResult = gregorianToJalali(new YearMonthDate(persianDate.getYear(), persianDate.getMonth(), persianDate.getDay()));
        return new PersianDate(gregorianToJalaliResult.getYear(), gregorianToJalaliResult.getMonth(), gregorianToJalaliResult.getDate(), persianDate.getHour(), persianDate.getMin(), persianDate.getSecond());
    }
    ...
    public static class PersianDate {
        ...
        public PersianDate(Date date, Locale aLocale) {
        ...
        public PersianDate(int year, int month, int day, int hour, int min, int second) {
            this.year = year;
            this.month = month;
            this.day = day;
            this.hour = hour;
        ...
        public String toString() {
            return getYear() + "/" + getMonth() + "/" + getDay() + " " + hour + ":" + min + ":" + second;
        }
    }
}
